...
public:
	...
	virtual void drawCubeFront() {
		//implement in derived class please.
	}

	virtual void drawCubeBack() {
		//implement in derived class please.
	}

	virtual void drawCubeLeft() {
		//implement in derived class please.
	}

	virtual void drawCubeRight() {
		//implement in derived class please.
	}

	virtual void drawCubeTop () {
		//implement in derived class please.
	}

	virtual void drawCubeBottom() {
		//implement in derived class please.
	}
	...
	static void drawCube(CharModel* arr[numMainModels]) {
	...
	static void drawCubeFront(CharModel* arr[numMainModels]) {
		for (int i = 0; i < numMainModels; i++) {
			if (arr[i]) {
				arr[i]->drawCubeFront();
			}
	...
	static void drawCubeBack(CharModel* arr[numMainModels]) {
		for (int i = 0; i < numMainModels; i++) {
			if (arr[i]) {
				arr[i]->drawCubeBack();
			}
	...
	static void drawCubeTop(CharModel* arr[numMainModels]) {
		for (int i = 0; i < numMainModels; i++) {
			if (arr[i]) {
				arr[i]->drawCubeTop();
			}
	...
	static void drawCubeBottom(CharModel* arr[numMainModels]) {
		for (int i = 0; i < numMainModels; i++) {
			if (arr[i]) {
				arr[i]->drawCubeBottom();
			}
		}
	}
	static void drawCubeRight(CharModel* arr[numMainModels]) {
		for (int i = 0; i < numMainModels; i++) {
			if (arr[i]) {
				arr[i]->drawCubeRight();
			}
	...
	static void drawCubeLeft(CharModel* arr[numMainModels]) {
		for (int i = 0; i < numMainModels; i++) {
			if (arr[i]) {
				arr[i]->drawCubeLeft();
			}
...
class ModelF1 : public CharModel {
public:

	ModelF1(int shaderProgram) : CharModel(shaderProgram) {
	...
	void drawCube() {
		...
		drawModelF1(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF1Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF1Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF1Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
...
private:
	...
	void drawModelF1(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
	...
	void drawModelF1Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF1Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF1Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF2 : public CharModel {
public:

	ModelF2(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF2(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF2Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF2Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
...
private:
	...
	void drawModelF2(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF2Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF2Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF3 : public CharModel {
public:

	ModelF3(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF3(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF3Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF3Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF3Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:

	void drawModelF3(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF3Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF3Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF3Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF4 : public CharModel {
public:

	ModelF4(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF4(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF4Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF4Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

private:
	
	void drawModelF4(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF4Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF4Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF5 : public CharModel {
public:

	ModelF5(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF5(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF5Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF5Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:

	void drawModelF5(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF5Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF5Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF6 : public CharModel {
public:

	ModelF6(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF6(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF6Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:

	void drawModelF6(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF6Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF7 : public CharModel {
public:

	ModelF7(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF7(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF7Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF7Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF7Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
...
private:
	...
	void drawModelF7(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF7Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF7Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF7Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF8 : public CharModel {
public:

	ModelF8(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF8(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF8Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
...
private:
	...
	void drawModelF8(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF8Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF8Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF8Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelF9 : public CharModel {
public:

	ModelF9(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF9(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

	void drawCubeFront() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelF9Front(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
...
private:
	...
	void drawModelF9(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF9Front(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelF9Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM1 : public CharModel {
public:

	ModelM1(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM1(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM1Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM1Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:

	void drawModelM1(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM1Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM1Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM2 : public CharModel {
public:

	ModelM2(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM2(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM2Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:

	void drawModelM2(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM2Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM3 : public CharModel {
public:

	ModelM3(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM3(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
		drawModelM3Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
...
private:
	...
	void drawModelM3(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM3Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM3Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM4 : public CharModel {
public:

	ModelM4(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM4(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM4Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelM4(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM4Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM5 : public CharModel {
public:

	ModelM5(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM5(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM5Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelM5(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM5Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM6 : public CharModel {
public:

	ModelM6(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM6(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

private:
	
	void drawModelM6(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM7 : public CharModel {
public:

	ModelM7(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM7(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM7Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM7Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
...
private:
	...
	void drawModelM7(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM7Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM7Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM8 : public CharModel {
public:

	ModelM8(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM8(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM8Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM8Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelM8(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM8Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM8Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelM9 : public CharModel {
public:

	ModelM9(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM9(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelM9Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelM9(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelM9Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB1 : public CharModel {
public:

	ModelB1(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB1(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB1Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB1Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB1Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}

private:
	
	void drawModelB1(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB1Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB1Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB1Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB2 : public CharModel {
public:

	ModelB2(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB2(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB2Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB2Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB2(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB2Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB2Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB3 : public CharModel {
public:

	ModelB3(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB3(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB3Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB3Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBottom() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB3Bottom(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB3(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB3Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB3Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB3Bottom(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB4 : public CharModel {
public:

	ModelB4(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB4(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB4Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB4Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB4(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB4Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB4Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB5 : public CharModel {
public:

	ModelB5(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB5(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB5Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB5Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
private:
	
	void drawModelB5(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB5Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB5Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB6 : public CharModel {
public:

	ModelB6(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB6(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB6Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB6(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB6Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB7 : public CharModel {
public:

	ModelB7(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB7(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB7Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeRight() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB7Right(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB7Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB7(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB7Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB7Right(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB7Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB8 : public CharModel {
public:

	ModelB8(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB8(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB8Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeLeft() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB8Left(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB8Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB8(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB8Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB8Left(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB8Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
class ModelB9 : public CharModel {
public:

	ModelB9(int shaderProgram) : CharModel(shaderProgram) {
		//initialize initial_relativeTranslateMatrix here and set relativeTranslateMatrix to that value.
		initY = -2.0f;
		initial_relativeTranslateMatrix =
			translate(mat4(1.0f),
	...
	void drawCube() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB9(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeBack() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB9Back(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}
	void drawCubeTop() {
		//pass arguments stored in parent class.
		glUniform3f(colorLocation, 1.0f,1.0f, 1.0f);
		drawModelB9Top(worldMatrixLocation, colorLocation, getRelativeWorldMatrix());
	}


private:
	
	void drawModelB9(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB9Back(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
	...
	void drawModelB9Top(GLuint worldMatrixLocation, GLuint colorLocation, mat4 relativeWorldMatrix) {
		//code goes here
		mat4 mWorldMatrix;
		mat4 scalingMatrix, translationMatrix;
		glm::mat4 worldMatrix = translationMatrix * scalingMatrix;
...
int createTexturedCubeVertexArrayObjectFront()
{
	// Cube model (used for models and axis)
...
int createTexturedCubeVertexArrayObjectLeft()
{
	// Cube model (used for models and axis)
...
int createTexturedCubeVertexArrayObjectRight()
{
	// Cube model (used for models and axis)
...
int createTexturedCubeVertexArrayObjectBack()
{
	// Cube model (used for models and axis)
...
int createTexturedCubeVertexArrayObjectTop()
{
	// Cube model (used for models and axis)
...
int createTexturedCubeVertexArrayObjectBottom()
{
	// Cube model (used for models and axis)
...
void renderModelsFront(RenderInfo renderInfo, CharModel* models[numMainModels]) {
	int shaderProgram = renderInfo.shaderProgram;
	GLuint colorLocation = renderInfo.colorLocation;
	GLuint enableTextureLocation = renderInfo.enableTextureLocation;
	GLuint worldMatrixLocation = renderInfo.worldMatrixLocation;
	...
	CharModel::drawCubeFront(models);
...
void renderModelsBottom(RenderInfo renderInfo, CharModel* models[numMainModels]) {
	int shaderProgram = renderInfo.shaderProgram;
	GLuint colorLocation = renderInfo.colorLocation;
	GLuint enableTextureLocation = renderInfo.enableTextureLocation;
	GLuint worldMatrixLocation = renderInfo.worldMatrixLocation;
	...
	CharModel::drawCubeBottom(models);
...
void renderModelsLeft(RenderInfo renderInfo, CharModel* models[numMainModels]) {
	int shaderProgram = renderInfo.shaderProgram;
	GLuint colorLocation = renderInfo.colorLocation;
	GLuint enableTextureLocation = renderInfo.enableTextureLocation;
	GLuint worldMatrixLocation = renderInfo.worldMatrixLocation;
...
void renderModelsRight(RenderInfo renderInfo, CharModel* models[numMainModels]) {
	int shaderProgram = renderInfo.shaderProgram;
	GLuint colorLocation = renderInfo.colorLocation;
	GLuint enableTextureLocation = renderInfo.enableTextureLocation;
	GLuint worldMatrixLocation = renderInfo.worldMatrixLocation;
	...
	CharModel::drawCubeRight(models);
...
void renderModelsTop(RenderInfo renderInfo, CharModel* models[numMainModels]) {
	int shaderProgram = renderInfo.shaderProgram;
	GLuint colorLocation = renderInfo.colorLocation;
	GLuint enableTextureLocation = renderInfo.enableTextureLocation;
	GLuint worldMatrixLocation = renderInfo.worldMatrixLocation;
...
void renderModelsBack(RenderInfo renderInfo, CharModel* models[numMainModels]) {
	int shaderProgram = renderInfo.shaderProgram;
	GLuint colorLocation = renderInfo.colorLocation;
	GLuint enableTextureLocation = renderInfo.enableTextureLocation;
	GLuint worldMatrixLocation = renderInfo.worldMatrixLocation;
...
int main(int argc, char* argv[])
{
	...
	int cubeVAOFront = createTexturedCubeVertexArrayObjectFront();
	int cubeVAOLeft = createTexturedCubeVertexArrayObjectLeft();
	int cubeVAORight = createTexturedCubeVertexArrayObjectRight();
	int cubeVAOTop = createTexturedCubeVertexArrayObjectTop();
	int cubeVAOBottom = createTexturedCubeVertexArrayObjectBottom();
	int cubeVAOBack = createTexturedCubeVertexArrayObjectBack();
	...
	ModelF1 f1(shaderProgram);
	ModelF2 f2(shaderProgram);
	ModelF3 f3(shaderProgram);
	ModelF4 f4(shaderProgram);
	ModelF5 f5(shaderProgram);
	ModelF6 f6(shaderProgram);
	ModelF7 f7(shaderProgram);
	ModelF8 f8(shaderProgram);
	ModelF9 f9(shaderProgram);
	ModelM1 m1(shaderProgram);
	ModelM2 m2(shaderProgram);
	ModelM3 m3(shaderProgram);
	ModelM4 m4(shaderProgram);
	ModelM5 m5(shaderProgram);
	ModelM6 m6(shaderProgram);
	ModelM7 m7(shaderProgram);
	ModelM8 m8(shaderProgram);
	ModelM9 m9(shaderProgram);
	ModelB1 b1(shaderProgram);
	ModelB2 b2(shaderProgram);
	ModelB3 b3(shaderProgram);
	ModelB4 b4(shaderProgram);
	ModelB5 b5(shaderProgram);
	ModelB6 b6(shaderProgram);
	ModelB7 b7(shaderProgram);
	ModelB8 b8(shaderProgram);
	ModelB9 b9(shaderProgram);
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   // --------------------------------------------------------------
		...
		/*
		glBindBuffer(GL_ARRAY_BUFFER, cubeVAOFront);

		renderDecor(renderInfo);
		renderModelsFront(renderInfo, models);
		*/
...
//}
		...
		// Draw geometry
		glBindBuffer(GL_ARRAY_BUFFER, cubeVAOBack);
		...
		//draw models
		{
			...
			//glBindTexture(GL_TEXTURE_2D, brickTextureID);
			renderModelsBack(renderInfo, models);
			CharModel::update(models, dt);

		}
		glBindVertexArray(cubeVAOTop);
		// Draw geometry
		glBindBuffer(GL_ARRAY_BUFFER, cubeVAOTop);
		...
		//draw models
		{
			...
			//glBindTexture(GL_TEXTURE_2D, brickTextureID);
			renderModelsTop(renderInfo, models);
			CharModel::update(models, dt);

		}
		glBindVertexArray(cubeVAOBottom);
		// Draw geometry
		glBindBuffer(GL_ARRAY_BUFFER, cubeVAOBottom);
		...
		//draw models
		{
			...
			//glBindTexture(GL_TEXTURE_2D, brickTextureID);
			renderModelsBottom(renderInfo, models);
			CharModel::update(models, dt);

		}
		glBindVertexArray(cubeVAOLeft);
		// Draw geometry
		glBindBuffer(GL_ARRAY_BUFFER, cubeVAOLeft);
		...
		//draw models
		{
			...
			//glBindTexture(GL_TEXTURE_2D, brickTextureID);
			renderModelsLeft(renderInfo, models);
			CharModel::update(models, dt);

		}
		glBindVertexArray(cubeVAORight);
		// Draw geometry
		glBindBuffer(GL_ARRAY_BUFFER, cubeVAORight);
		...
		//draw models
		{
			...
			//glBindTexture(GL_TEXTURE_2D, brickTextureID);
			renderModelsRight(renderInfo, models);
			CharModel::update(models, dt);
