...
void drawLightSourceS3(GLuint worldMatrixLocation, GLuint colorLocation) {
	...
	worldMatrix = translate(mat4(1.0f), lightPosS3) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
	glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
	glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
void drawLightSourceV9(GLuint worldMatrixLocation, GLuint colorLocation) {
	...
	// Draw point light source (a mini white cube just to see it)
	worldMatrix = translate(mat4(1.0f), lightPosV9) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
	glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
	glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
void drawLightSourceA9(GLuint worldMatrixLocation, GLuint colorLocation) {
	...
	// Draw point light source (a mini white cube just to see it)
	worldMatrix = translate(mat4(1.0f), lightPosA9) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
	glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
	glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
void drawLightSourceN2(GLuint worldMatrixLocation, GLuint colorLocation) {
	...
	// Draw point light source (a mini white cube just to see it)
	worldMatrix = translate(mat4(1.0f), lightPosN2) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
	glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
	glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
void drawLightSourceN4(GLuint worldMatrixLocation, GLuint colorLocation) {
	...
	// Draw point light source (a mini white cube just to see it)
	worldMatrix = translate(mat4(1.0f), lightPosN4) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
	glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
	glUniform3f(colorLocation, 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
//    -100.0f, 100.0f);  // near/far (near == 0 is ok for ortho)
	...
	int vbo = createVertexBufferObject1();
